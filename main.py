...
def handle_text(message):
    ...
    if message.text == "🛠 Наши проекты":  
        ...
        keyboard.add(btn1, btn2)
        keyboard.add(btn3)
        bot.send_message(message.chat.id, "🔴 *ТЕНЕВОЙ БИЗНЕС* — Теневая инфроструктура в *Telegram.* Все о теневом бизнесе и о темных делишках только у нас.", reply_markup=keyboard, parse_mode='Markdown')
