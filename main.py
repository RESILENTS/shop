...
def handle_text(message):
    ...
    if message.text == "🛠 Наши проекты":  
        ...
        keyboard.add(btn1, btn2)
        keyboard.add(btn3)
        bot.send_message(message.chat.id, "🔴 *ТЕНЕВОЙ БИЗНЕС* — Теневая инфроструктура в *Telegram.* \n\nВсе о теневом бизнесе и о темных делишках только у нас.\n\nРазвивайся в теневой сфере вместе с нами.\n\n➕ Подпишись на наши проекты и зови друзей.", reply_markup=keyboard, parse_mode='Markdown')
